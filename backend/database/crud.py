...
def create_deployment(db: Session, deployment_name: str, repo_url: str, pat_token_provided: bool, status: str = "Created"):
...
# --- NEW: Function to delete a deployment record ---
